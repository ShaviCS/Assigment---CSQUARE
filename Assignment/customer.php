...
<form method ="post"   action="">
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <h1>Middle Name</h1>
	    <input type="text" name="middle_name" class="form-control" placeholder="Enter Middle Name" value="<?php echo($middle_name);?>" required>
    </div>
    <div class="col-xs-6">
      <h1>Last Name</h1>
  ...
  <h1>Contact no. (10-digit)</h1>
	<input type="tel" pattern="^\d{10}$" class="form-control" name="contact_no"  placeholder="Enter Contact Number" value="<?php echo($contact_no);?>" required>
  ...
  <br/>
    ...
    <a href="http://localhost/assignment/updatecustomerdata.php"<button class="btn btn-info btn-block btn-lg">Update | Delete | Find</button></a>
