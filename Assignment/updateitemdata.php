...
<form method ="post"   action="">
	<div class="form-group row">
		<div class="col-xs-6">
			<h1>ID Number</h1>
			<input type="number" name="id"  class="form-control" placeholder="ID No." value="<?php echo($id);?>">
		</div>
		<div class="col-xs-6">
			<h1>Item Code</h1>
			<input type="text" name="item_code" class="form-control" placeholder="Enter Item Code" value="<?php echo($item_code);?>">
		</div>
  	</div>
	<div class="form-group row">
		<div class="col-xs-6">
  ...
  <h1>Item Name</h1>
	<input type="text" name="item_name" class="form-control" placeholder="Enter Item Name" value="<?php echo($item_name);?>">
  
  <h1>Quantity</h1>
	<input type="number" name="quantity" class="form-control" placeholder="Enter Quantity" value="<?php echo($quantity);?>">
  
  <h1>Unit Price</h1>
	<input type="number" name="unit_price" class="form-control" placeholder="Enter Unit Price" value="<?php echo($unit_price);?>">
